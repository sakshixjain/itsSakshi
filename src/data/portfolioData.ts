...
export const SKILL_GROUPS: SkillGroup[] = [
  ...
  },
  {
    ...
    category: "backend",
    skills: [
      { name: "Node.js", badge: "Expert" },
      { name: "Express.js", badge: "Expert" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "WebSockets", badge: "Advanced" },
    ],
  },
  {
    ...
    category: "cs",
    skills: [
      { name: "Data Structures & Algorithms (DSA)", badge: "Expert" },
      { name: "390+ LeetCode & GfG Solved", badge: "Expert" },
      { name: "Object Oriented Programming (OOP)", badge: "Expert" },
      { name: "Authentication (JWT, RBAC)", badge: "Advanced" },
      { name: "CRUD & Database Architecture", badge: "Expert" },
      { name: "Gemini / AI API Integration", badge: "Advanced" },
    ],
  },
];
...
export const EDUCATION_ITEMS: EducationItem[] = [
  {
    ...
    highlights: ["Data Structures & Algorithms", "Object-Oriented Programming", "DBMS & SQL", "Operating Systems", "Web Tech"],
  },
  {
    ...
    highlights: ["Digital Circuit Design", "C/C++ Programming", "Microprocessors", "Logic Systems"],
  },
];
